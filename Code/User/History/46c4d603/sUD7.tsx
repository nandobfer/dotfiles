...
export const Chat: React.FC<ChatProps> = ({ chat }) => {
    return (
        <Paper elevation={3} sx={{ padding: "1vw", backgroundColor: "background.default", alignItems: "center", gap: "1vw", width: "100%" }}>
            ...
            >
                ...
                <p style={{ whiteSpace: "nowrap", textOverflow: "ellipsis", width: "17vw", overflow: "hidden" }}>{chat.lastMessage.body}</p>
            </Box>
            <Box
                sx={{
                    width: "100%",
