...
export const Signup: React.FC<SignupProps> = ({ user }) => {
    ...
    return (
        <Paper
            sx={{ flexDirection: "column", justifyContent: "space-evenly", width: "100%", padding: "10vw", textAlign: "center", borderRadius: "5vw" }}
        >
            ...
            <Button variant="contained" onClick={() => navigate("/business/signup")}>
                Começar cadastro
            </Button>
        </Paper>
    )
