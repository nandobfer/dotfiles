                ...
                <>
                    <div className="info-container">
                        <div className="data-container">
                            <Formik></Formik>
                            <p>Dados Pessoais</p>
                            <TextField label={"Nome"} value={seller.name} InputProps={{ readOnly: !user!.adm, sx: textfield_style }} />
                            <MaskedInput
                                mask={useCpfMask}
                                guide={false}
                                name="cpf"
                                value={seller.cpf}
                                render={(ref, props) => (
                                    <TextField label={"CPF"} inputRef={ref} {...props} InputProps={{ readOnly: !user!.adm, sx: textfield_style }} />
                                )}
                            />

                            <TextField label={"E-mail"} value={seller.email} InputProps={{ readOnly: !user!.adm, sx: textfield_style }} />
                            <TextField
                        ...
                        <div className="data-container">
                            <TextField label={"Função"} value={seller.role} InputProps={{ readOnly: !user!.adm, sx: textfield_style }} select>
                                {roles.map((role) => (
                            ...
                            <TextField label={"Endereço"} value={seller.address} InputProps={{ readOnly: !user!.adm, sx: textfield_style }} />
