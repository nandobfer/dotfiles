...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({}) => {
    ...
    return (
        <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description" sx={styles.dialog} PaperProps={{sx: {sx={{ bgcolor: "red" }}}}}>
