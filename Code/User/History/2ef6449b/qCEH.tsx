...
export const Gallery: React.FC<GalleryProps> = ({ navigation }) => {
    ...
    return (
        ...
        >
            <ImageBackground source={images.background.planes} style={{ flex: 1, paddingTop: 20, paddingBottom: 20 }}>
                <Text
                ...
                <FlatList
                    ...
                    contentContainerStyle={{ gap: 20, paddingLeft: 20, paddingRight: 20, alignItems: "center" }}
