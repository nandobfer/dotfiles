...
export const CameraContainer: React.FC<CameraContainerProps> = ({ navigation }) => {
    ...
    return (
        ...
        >
            ...
            <IconButton icon={"format-text-variant-outline"} iconColor={colors.primary} size={50} style={{ alignSelf: "flex-end" }} />
            <TouchableOpacity
                style={{
                    borderColor: "white",
                    borderWidth: 1,
            ...
            ></TouchableOpacity>
            <Modal visible={openSettings} onDismiss={() => setOpenSettings(false)}>
