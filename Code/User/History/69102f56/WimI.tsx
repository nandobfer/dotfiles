                                            ...
                                            <Box sx={{ flexDirection: "column", gap: "1vw", width: "50%" }}>
                                                <Box sx={style_icon}>
                                                    ...
                                                    <p style={{ fontWeight: "700", fontSize: "1vw", color: "gray" }}>
                                                        Nome Completo:<span style={{ fontWeight: "500" }}> {values.name}</span>
                                                    </p>
                                                </Box>
                                                <Box sx={style_icon}>
                                                    <FolderOpenIcon fontSize="small" />
                                                    <p style={{ fontWeight: "700", fontSize: "1vw", color: "gray" }}>
                                                        CPF:<span style={{ fontWeight: "500" }}> {values.cpf}</span>
                                                    </p>
                                                </Box>
                                                <Box sx={style_icon}>
                                                    <DateRangeIcon fontSize="small" />
                                                    <p style={{ fontWeight: "700", fontSize: "1vw", color: "gray" }}>
                                                        Data de Nascimento:<span style={{ fontWeight: "500" }}> {values.birth}</span>
                                                    </p>
                                                </Box>
                                            </Box>
                                            <Box sx={{ flexDirection: "column", gap: "1vw", width: "50%" }}>
                                                ...
                                                <Box sx={style_icon}>
                                                    ...
                                                    <p style={{ fontWeight: "700", fontSize: "1vw", color: "gray" }}>
                                                        E-mail:<span style={{ fontWeight: "500" }}> {values.email}</span>
                                                    </p>
                                                </Box>
                                                <Box sx={style_icon}>
                                                    <PermIdentityIcon fontSize="small" />
                                                    <p style={{ fontWeight: "700", fontSize: "1vw", color: "gray" }}>
                                                        Username:<span style={{ fontWeight: "500" }}> @{values.username}</span>
                                                    </p>
                                                </Box>
                                            </Box>
                                        </Box>
