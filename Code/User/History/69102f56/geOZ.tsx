...
import MailOutlions-material/MailOutline"
con from "@mui/iconsal/Phone"
rmIdentityIcon from -material/PermIdentity"
t FolderOpenIcon froaterial/FolderOpen"
on from "@mui/icons-terial/DateRange"
ldsOutlinedIcon from/icons-material/TextFieldsOutlined"
kOutlineOutlinedIconi/icons-material/WorkOutlineOutlined"
{ textFieldStyle } f/../style/textfield"
ort MaskedInput from "..nts/MaskedInput"
Formik } from "formik"
Io } from "../../../../hIo"
 useDepartments } from "hooks/useDepartments"
 } from "burgos-snackbar"
import { selectM../../../style/selectMenuStyle"
olors } from/../../hooks/useColors"
Avatar as Avatarom "@files-ui/react"
...
ofile: React.FC<eUsersProps> = ({ user, variant = "default" }) => {
list, remove } =()
t { confirm } = alog()
