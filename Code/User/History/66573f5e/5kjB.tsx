...
export const Test: React.FC<{ value: string; handleChange: React.ChangeEventHandler<HTMLTextAreaElement | HTMLInputElement> }> = ({
    value,
    handleChange,
}) => {
            ...
            <Formik initialValues={{ username: "", email: "", document: "", password: "", name: "" }} onSubmit={handleSubmit}>
                {({ values, handleChange }) => (
                    <Form>
                        ...
                        <Test handleChange={handleChange} value={values.document} />
