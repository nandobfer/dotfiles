                ...
                >
                    ...
                    <Box sx={{ flexDirection: "column", alignItems: "center", gap: "1.2vw" }}>
                        ...
                        <Box sx={{ flexDirection: "row", gap: "1vw" }}>
                            <Tag name="Produtor" variant="producer" style={"2vw"} />
                            <Tag name="Corretor" variant="agent" style={"2vw"} />
                            <Tag name="Transportador" variant="shipping" style={"2vw"} />
                            <Tag name="Loja" variant="ads" style={"2vw"} />
                            <Tag name="ADM" variant="adm" style={"2vw"} />
                        </Box>
                    </Box>
                    <Box sx={{ gap: "5vw" }}>
