...
import { Box, Button, Checkbox, CircularProgress, ListItemText, MenuItem, Select, TextField } from "@mui/material"
                        ...
                        <Box sx={{ gap: "1vw", width: "74vw" }}>
                            ...
                            <Box sx={{ flexDirection: "column", gap: "1vw", flex: 1 }}>
                                ...
                                <Select
                                    ...
                                    value={values.role}
                                    onChange={handleChange}
                                    input={<TextField label="funções" />}
                                    renderValue={(selected) => selected.toString().join(", ")}
