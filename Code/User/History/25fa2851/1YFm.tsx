...
export const Boards: React.FC<BoardsProps> = ({ user }) => {
    ...
    const [boardList, setBoardList] = useState(boards.list)
    ...
    const onSearch = (value: string) => {
        const searchResult = boards.list.filter((board) => board.name.toLowerCase().includes(value))
        setBoardList(searchResult)
    }
