...
export const CanvasContainer: React.FC<CanvasContainerProps> = ({ navigation, image, shouldUndo, setShouldUndo, updateColor, stroke }) => {
    ...
    const onTouchMove = (event: GestureResponderEvent) => {
        ...
        // Clip the touch position to the SVG container dimensions
        locationX = Math.min(Math.max(0, locationX), imageWidth)
        locationY = Math.min(Math.max(0, locationY), imageHeight)
