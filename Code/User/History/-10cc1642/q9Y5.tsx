        ...
        <Modal visible={open} onDismiss={onClose}>
            <View style={{ padding: 20, gap: 30 }}>
                ...
                <View style={{ flexDirection: "row", gap: 20 }}>
                    <Button icon={"eraser-variant"} mode="text" onPress={() => text.setText("")} style={styles.button}>
                        limpar
                    </Button>
                    <Button icon="clipboard-file" mode="text" onPress={handlePaste} style={styles.button}>
                        colar
                    </Button>
                </View>
            </View>
