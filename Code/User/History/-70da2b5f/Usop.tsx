                ...
                {({ values, handleChange }) => (
                    <Form>
                        ...
                        <Box sx={{ flexWrap: "wrap", width: "100%" }}>
                            <TextField label="" placeholder="Tarifa de energia em %" name="green" value={values.green} onChange={handleChange} />
                            <TextField label="" placeholder="Tarifa de energia em %" name="yellow" value={values.yellow} onChange={handleChange} />
                            <TextField label="" placeholder="Tarifa de energia em %" name="red" value={values.red} onChange={handleChange} />
                            <TextField label="" placeholder="Tarifa de energia em %" name="red2" value={values.red2} onChange={handleChange} />
                        </Box>
