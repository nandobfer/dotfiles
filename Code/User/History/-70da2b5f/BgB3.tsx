                    ...
                    <Form>
                        ...
                        <Box sx={{ flexWrap: "wrap", width: "100%", gap: "1vw" }}>
                            <TextField
                                ...
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/green.svg" style={imgStyle} /> }}
                            />
                            <TextField
                                label="Amarela"
                                name="yellow"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/yellow.svg" style={imgStyle} /> }}
                            />
                            <TextField
                                label="Vermelha"
                                name="red"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/red.svg" style={imgStyle} /> }}
                            />
                            <TextField
                                label="Vermelha 2"
                                name="red2"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/red2.svg" style={imgStyle} /> }}
                            />
                        </Box>
