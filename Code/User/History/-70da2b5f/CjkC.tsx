                    ...
                    <Form>
                        ...
                        <Box sx={{ flexWrap: "wrap", width: "100%", gap: "1vw" }}>
                            <TextField
                                ...
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/green.svg" /> }}
                            />
                            <TextField
                                label="Amarela"
                                name="yellow"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/yellow.svg" /> }}
                            />
                            <TextField
                                label="Vermelha"
                                name="red"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/red.svg" /> }}
                            />
                            <TextField
                                label="Vermelha 2"
                                name="red2"
                                ...
                                onChange={handleChange}
                                sx={inputStyle}
                                InputProps={{ startAdornment: <img src="/flags/red2.svg" /> }}
                            />
                        </Box>
