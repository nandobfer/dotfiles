                ...
                {({ values, handleChange }) => (
                    <Form>
                        ...
                        <Box sx={{ flexWrap: "wrap", width: "100%", gap: "1vw" }}>
                            <TextField label="green" name="green" value={values.green} onChange={handleChange} sx={inputStyle} />
                            <TextField label="yellow" name="yellow" value={values.yellow} onChange={handleChange} sx={inputStyle} />
                            <TextField label="red" name="red" value={values.red} onChange={handleChange} sx={inputStyle} />
                            <TextField label="red2" name="red2" value={values.red2} onChange={handleChange} sx={inputStyle} />
                        </Box>
