                ...
                {({ values, handleChange }) => (
                    <Form>
                        ...
                        <Box sx={{ flexWrap: "wrap", width: "100%", gap: "1vw" }}>
                            <TextField label="Verde" name="green" value={values.green} onChange={handleChange} sx={inputStyle} />
                            <TextField label="Amarela" name="yellow" value={values.yellow} onChange={handleChange} sx={inputStyle} />
                            <TextField label="Vermelha" name="red" value={values.red} onChange={handleChange} sx={inputStyle} />
                            <TextField label="Vermelha 2" name="red2" value={values.red2} onChange={handleChange} sx={inputStyle} />
                        </Box>
