...
import { Box, Button, CircularProgress, FormControlLabel, Paper, SxProps, TextField } from "@mui/material"
                    ...
                    <Formu>
                        <Paper sx={paperStyle}>
                            ...
                            <Box sx={{ justifyContent: "space-between" }}>
                                <FormControlLabel label="Loja" onChange={handleChange} name="store" value={values.store} control={<CheckBox />} />
                                <FormControlLabel
                                    label="Serviço"
